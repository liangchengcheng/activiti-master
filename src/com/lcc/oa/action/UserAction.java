...
public class UserAction {
    ...
    // 如果执行删除，工作流审批中的代办任务和待签收任务将无法使用。
    //（在act_ru_identitylink将查不到act_id_user、act_id_group和act_id_membership的信息）
    ...
    public String chooseUser(@RequestParam("groupId") String groupId, @RequestParam("flag") boolean flag,
                             @RequestParam("key") String key, Model model) throws Exception {
